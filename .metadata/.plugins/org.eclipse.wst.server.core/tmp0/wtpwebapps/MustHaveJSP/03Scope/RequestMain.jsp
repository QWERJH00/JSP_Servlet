...
<%
/*
	request영역 : 클라이언트가 요청을 할때마다 새로운 request개게가
...
<body>
	...
	/*
		...
		즉 하나의 요청을 둘 이상의 페이지가 공유할 수 있다. 포워드 명령을 만나기
		전까지의 모든 내용은 버퍼에서 삭제되고, 포워드된 페이지의 내용만 화면에
		출력하는 특징을 갖는다. 즉 포워드란 현재 페이지로 들어온 요청을
