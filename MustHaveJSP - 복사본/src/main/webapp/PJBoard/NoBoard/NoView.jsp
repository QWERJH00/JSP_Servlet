...
<body>
	...
	<!-- 
	 ...
	 -->
	<input type="h-idden" name="num" value="<%= num %>" />  
	    <table border="1" width="90%">
	        ...
	        <tr>
	        	<td>첨부파일</td>
	        	<td><a href="Download2.jsp?oName=<%= URLEncoder.encode(dto.getOfile(),"UTF-8") %>&sName=<%= URLEncoder.encode(dto.getSfile(),"UTF-8") %>">[다운로드]</a></td>
	        </tr>
	        <tr>
	            <td colspan="4" align="center">
					...
					*/
					...
					%>
						<button type="button"
						        onclick="location.href='NoEdit.jsp?num=<%= dto.getNum() %>';">
						    수정하기</button>
						<button type="button" onclick="deletePost();">삭제하기</button> 
					<%
					}
					%>
	                <button type="button" onclick="location.href='AdList.jsp';">
	                    목록 보기
	                </button>
	            </td>
	        </tr>
