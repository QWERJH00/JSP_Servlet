...
delete from pjmember where id='1111';
...
WHERE TABLE_NAME = 'pjmember';

alter table pjboard disable constraint board_mem_fk5;

alter table pjboard add constraint board_mem_fk5
foreign key (id) references pjmember(id) on delete cascade;
