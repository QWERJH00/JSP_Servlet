...
public class MemberAuth extends HttpServlet {
	...
	/*
	 	...
	 	최초한번만 호출되는 init()메서드에서 DB연결처리를 한다.
	*/
	@Override
	public void init() throws ServletException {
		...
		/*
		 	...
		 	서블릿 먼저 요청을 받기 때문에 모델1 방식과 같이 JSP에서
	...
	/*
	 	service()메서드는 get,post방식 둘다 요청을 받을 수 있으므로
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) 
		...
		*/
		...
		/*
		 	...
		 	있다면 회원레코드를 DTO에 저장한 후 반환한다. 만약 정보가
		 	일치하지 않는다면 내용이 없는 DTO를 반환하게 될것이다.
		*/
