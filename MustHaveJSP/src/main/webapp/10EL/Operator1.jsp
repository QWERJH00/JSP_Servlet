...
<body>
	...
	<!-- 
		톰켓8.0부터는 EL에서 변수할당을 할 수 있다. 하지만 변수할당과 
		동시에 출력되므로 할당문 뒤에 ;''를 붙여줘야 출력되지않는다.
		즉, EL에서 변수할당은 많이 사용되지 않는다.
	 -->
 	변수 할당 및 즉시 출력 : ${num1 = 7 } <br />
	변수 할당 및 변도 출력 : ${num2 = 8;'' } => ${num2 } <br />
	...
	num1 * num2 : ${num1 * num2 } <br />
	<!-- 
		나눗셈에서 /와 div연산자를 사용할 수 있다. 또한 자동형변환이 적용
		되므로 정수끼리의 연산에서 실수의 결과가 나올 수 있다.
	 -->
	...
	<!-- 
		...
		== : eq(EQual)
		!= : ne(Not Equal)
		Java에서 사용하는 기본적인 비교연산자와 문자형태의 연산자 2가지
		모두 사용할 수 있다.
	 -->
	<h3>비교 연산자</h3>
