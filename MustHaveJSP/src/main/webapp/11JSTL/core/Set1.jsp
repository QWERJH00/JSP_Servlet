...
<!-- 
 ...
 -->
	...
	<!-- 
		JSTL은 JSP코드이므로 value속성에 기술할때 객체를 생성하기 위함
		더블쿼테이션이 겹쳐지는 경우가 발생한다. 이때는 value를
	...
	<!-- 자바빈즈에 정의한 setter()를 통해 초기화한다. 값을 나중에 설정할려면
	target과 property속성을 사용한다. target에는 변수를 property에는 
	멤버변수명을 지정한다. -->
